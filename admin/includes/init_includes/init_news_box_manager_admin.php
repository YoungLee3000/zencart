...
if (!defined ('NEWS_BOX_MODULE_VERSION')) {
  ...
  $db->Execute ("INSERT INTO " . TABLE_CONFIGURATION . " ( configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, use_function, set_function ) VALUES ( 'Items to Show in Home Page', 'NEWS_BOX_SHOW_CENTERBOX', '4', 'Set the maximum number of the latest-news titles to show in the &quot;Latest News&quot; section at the bottom of your home page.  Set the value to 0 to disable the news display.', $cgi, 45, now(), NULL, NULL)");
...
if (!defined ('NEWS_BOX_CONTENT_LENGTH_CENTERBOX')) {
  $db->Execute ("INSERT INTO " . TABLE_CONFIGURATION . " ( configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, use_function, set_function ) VALUES ( 'Home Page News Content Length', 'NEWS_BOX_CONTENT_LENGTH_CENTERBOX', '130', 'Set the maximum number of characters (an integer value) of each article\'s content to display within the home-page center-box.  Set the value to <em>0</em> to disable the content display or to <em>-1</em> to display each article\'s entire content (no HTML will be stripped).', $cgi, 46, now(), NULL, NULL)");
