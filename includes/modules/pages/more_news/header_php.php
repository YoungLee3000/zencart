...
$news_box_query = $db->Execute ("SELECT nc.news_title, nc.news_content, nc.news_image, n.news_added_date, n.news_modified_date, n.news_start_date, n.news_end_date
                                  ...
                                  WHERE nc.box_news_id = $news_id 
                                    ...
                                    AND ( n.news_end_date = '0001-01-01 00:00:00' OR  n.news_end_date = '0000-00-00 00:00:00' OR now() <= n.news_end_date) LIMIT 1");
if ($news_box_query->EOF) {
  ...
  if (($news_box_query->fields['news_end_date'] != '0001-01-01 00:00:00') || ($news_box_query->fields['news_end_date'] != '0000-00-00 00:00:00')) {
