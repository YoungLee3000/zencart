...
if($GLOBALS[$class]->title == 'PayPal')
{
  echo zen_draw_form('checkout_confirmation', $form_action_url, 'post', 'id="checkout_confirmation" target="payFrame" onsubmit="submitonce();"');
}else
{
