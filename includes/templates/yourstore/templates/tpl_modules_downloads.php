...
?>
      ...
      <td class="centeredContent"><?php echo ($is_downloadable) ? '<a class="btn btn--ys" href="' . zen_href_link(FILENAME_DOWNLOAD, 'order=' . $last_order . '&id=' . $downloads->fields['orders_products_download_id']) . '">' . zen_image_button(BUTTON_IMAGE_DOWNLOAD, BUTTON_DOWNLOAD_ALT) . '</a>' : '&nbsp;'; ?></td>
    </tr>
<?php
    $downloads->MoveNext();
    }
